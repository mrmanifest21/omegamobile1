...
const CONTENT: Record<LegalDoc, { title: string; sections: { heading: string; body: string }[] }> = {
  privacy: {
    ...
    sections: [
      ...
      {
        heading: '6. Contact',
        body: 'For any privacy-related queries, contact our data officer at omegaelz@outlook.com or call +27 70 757 9866.',
      },
    ],
  },
  terms: {
  ...
  nda: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'We are happy to sign an NDA before any detailed project discussion. Contact us via email at omegaelz@outlook.com or WhatsApp at +27 70 757 9866 and we will have a document ready within 24 hours.',
      },
      {
